# En este ejemplo, se utiliza un evento para sincronizar procesos.
# El evento permite que un o varios procesos espere hasta que un proceso establezca el evento.
# Este ejemplo es una versión simplificada y renombrada del original.
